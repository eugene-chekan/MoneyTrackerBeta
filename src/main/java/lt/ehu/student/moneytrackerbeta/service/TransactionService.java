...
public interface TransactionService {
    boolean addTransaction(int userId, int type, String source, String destination, Timestamp date, BigDecimal amount,
    ...
    List<TransactionDto> findFilteredTransactions(int userId, int type, Timestamp fromDate, Timestamp toDate)
